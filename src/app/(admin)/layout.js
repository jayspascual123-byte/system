...
import { Activity, LogOut, User, LayoutDashboard, Database, BarChart3, Menu, X } from 'lucide-react';
...
export default function AdminLayout({ children }) {
  ...
  const navLinks = [
    ...
    { name: 'Patient Records (EHR)', path: '/records', icon: Database },
    { name: 'Operational Reports', path: '/reports', icon: BarChart3 },
  ];
        ...
        <div className="space-y-8 mt-12 md:mt-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] font-bold text-teal-400 tracking-widest uppercase">Admin Override Console</span>
            </div>
          </div>
