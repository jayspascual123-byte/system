...
import { Activity, LogOut, User, Calendar, Menu, X } from 'lucide-react';
...
export default function PatientLayout({ children }) {
  ...
  const navLinks = [
    { name: 'Dashboard & Booking', path: '/patient', icon: Calendar },
  ];
        ...
        <div className="space-y-8 mt-12 md:mt-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] font-bold text-teal-400 tracking-widest uppercase">Patient Terminal</span>
            </div>
          </div>
